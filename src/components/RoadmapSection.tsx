...
const RoadmapSection: React.FC = () => {
  return (
    <section className="py-14 sm:py-16 lg:py-20 bg-gradient-to-b from-white to-background relative overflow-hidden" id="roadmap">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.h2
          className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 text-center mb-12"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {steps.map((s, i) => (
              ...
              >
                ...
                <div className="h-full rounded-2xl bg-white/70 backdrop-blur border border-gray-100 shadow-sm hover:shadow-md transition-shadow p-5 sm:p-6">
